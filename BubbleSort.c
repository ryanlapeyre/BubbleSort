...
void BubbleSort2DimensionalArray(int[][SORTSIZE]);
void BubbleSortPointers(int*);
...
int main (void)
{
    ...
    BubbleSortPointers(pointerElements);
    PrintPointer(pointerElements);
    ...
    BubbleSort2DimensionalArray(arrayElements2Dimensional);
    Print2DimensionalArray(arrayElements2Dimensional);
    puts("");
    return 1;
}
...
void BubbleSort2DimensionalArray(int arrayElements2Dimensional[][SORTSIZE] )
{
    int firstCounter = 0;
    int secondCounter = 0;
    int thirdCounter = 0;
...
void BubbleSortPointers(int* pointerElements)
{
    int firstCounter = 0;
    int secondCounter = 0;
    int spareItem = 0;
...
void BubbleSortArray(int arrayElements[])
{
    int firstCounter = 0;
    int secondCounter = 0;
    int spareItem = 0;
